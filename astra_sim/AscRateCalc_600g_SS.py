...
m_p = np.array([.25,.5,.75,1,1.1])#np.array([0.588, .844])#np.arange(0.5,0.8,.05)#np.array([0.582]) #kg             PAYLOAD MASS
v = np.arange(0,7,.25) #m/s              ASCENT RATE, SWEEP
m_b = 0.6 #kg                           BALLOON MASS
Vtank = 0.97/35.315 #m3  (from ft3)       TANK VOLUME,  K cylinder (k type is 1.65ft3, S is 0.97ft3)
