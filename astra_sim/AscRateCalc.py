...
m_p = np.array([.25,.50,.75,1])#np.array([0.588, .844])#np.arange(0.5,0.8,.05)#np.array([0.582]) #kg             PAYLOAD MASS
v = np.arange(0,7,.25) #m/s              ASCENT RATE, SWEEP
m_b = 0.3 #kg                           BALLOON MASS
Vtank = 0.961/35.315 #m3  (from 0.961ft3)       TANK VOLUME, PRAXAIR, S cylinder

R_Burst = 3.6576/2#1.4935#(96/2) / 39.37 # meters (from in)
